...
| Frobenius and spectral norms | Golub and Van Loan, [*Matrix Computations*, 4th ed.](https://www.press.jhu.edu/books/title/10678/matrix-computations), and the official [NumPy norm reference](https://numpy.org/doc/stable/reference/generated/numpy.linalg.norm.html) | book: 4th edition (2013); documentation observed 2026-08-29 | Scholarly/software documentation citation; no book, documentation, or NumPy code redistributed | Mathematical definitions only; KEditAudit implementation is original standard-library code |
